...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && (localStorage.getItem("role") === "buyer" || localStorage.getItem("role") === "admin")) {
    ...
    <div className="hero__menu">
      ...
      <div className="nav-btn mr2">
        {isAuthenticated ? ( <>
          ...
          <div className="notification" onClick={() => setShowNotifications(!showNotifications)}  id={localStorage.getItem("role") === "seller"|| localStorage.getItem("role") === "admin"?"":"dn"}>
            <svg width="32" height="32" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
<circle cx="25" cy="25" r="25" fill="#E7D400"/>
<path d="M26.5858 34.2499C26.4247 34.5277 26.1934 34.7583 25.915 34.9187C25.6367 35.079 25.3212 35.1633 25 35.1633C24.6788 35.1633 24.3633 35.079 24.085 34.9187C23.8066 34.7583 23.5753 34.5277 23.4142 34.2499M30.5 22.6999C30.5 21.1443 29.9207 19.652 28.8894 18.552C27.8582 17.452 26.4575 16.8333 25 16.8333C23.5425 16.8333 22.1428 17.4511 21.1106 18.552C20.0793 19.652 19.5 21.1443 19.5 22.6999C19.5 29.5447 16.75 31.4999 16.75 31.4999H33.25C33.25 31.4999 30.5 29.5447 30.5 22.6999Z" stroke="black" stroke-width="1.375" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
