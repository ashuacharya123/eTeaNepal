...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (storedAvatar === "undefined") return;
    if (storedAvatar) {
  ...
  useEffect(() => {
    ...
    if (isAuthenticated && (localStorage.getItem("role") === "buyer"||"admin")) {
      ...
      <div className="nav-btn mr2">
        {isAuthenticated ? (
          <>
            ...
            <div className="notification" onClick={() => setShowNotifications(!showNotifications)}  id={localStorage.getItem("role") === ("seller"||"admin") ?"":"dn"}>
